...
Nu ska vi lära oss om Endpoint Detection and Response!

Några större lösningar som finns idag:
- CrowdStrike Falcon
...
Visibility - Detection - Response. Mycket text där rummet förklarar att man får tillgång till ett processträd, lista av upptäckter med mera.

Väldigt intressant rum. Nu har jag en mycket bättre bild av vad en EDR faktiskt gör och hur den arbetar. Att EDR:en tar in en bred bas av data från endpointen, bl.a. processer och vilka parent-child-förhållanden de har, nätverkshändelser, CLI-aktivitet, registret och mycket mer för att se så inga konstigheter försegår.

![EDR](<bilder/Skärmbild 2026-01-23 introductiontoEDR.png>)

## Splunk: The Basics

Det här ska bli kul. Splunk har jag tittat på litegrann men inte nog mycket.

Här får jag öppna upp en Splunk-instans och titta runt och förstå att den använder sig av forwarders, dvs en agent. Den har en indexing-komponent som hanterar datan och en sökmotor som kallas Search Head.

Fick prova lite egna sökningar och det var skönt när jag insåg att man kan använda sig av lite bekant syntax i sökningarna. Då jag skulle hitta hur många events det fanns från alla länder utom frankrike så behövde jag använda mig av söksträngen "Source_Country!=France" vilket kändes bekant och skönt.

![Splunk](<bilder/Skärmbild 2026-01-23 splunk.png>)

## Elastic Stack: The Basics

Så Elastic Stack är baserad på följande komponenter:
- Elastic Search
- Logstash
- Beats
- Kibana

Alla fyller en viss funktion och i slutändan skapas en sorts SIEM även om det inte riktigt är en?

Det här rummet går genom tydligare hur man söker än de gjorde i Splunk-rummet, tyvärr, då jag nästan tror att Splunk är vanligare. Men förhoppningsvis fungerar väl sökmotorerna ungefär likadant.

Skapa visualisationer känns som de kan vara bra för rapporter av olika slag, kanske också dag-till-dag men är inte helt säker. Inte helt enkelt det där heller, men man lär sig nog om man arbetar med det ett tag.

![ELK](<bilder/Skärmbild 2026-01-23 elkstack.png>)

## Introduction to SOAR

Security Orchestration, Automation, and Response (SOAR)

Ett rum med mestadels text som känns myckte som upprepning från tidigare. Sista uppgiften då man ska gissa vad TryHackMe riktigt syftar på med de olika funktionerna inom case ticket, threat intel, data extraction osv är i vanlig ordning bedrövlig. Svår att tolka i alla lägen. Men till slut så löser man det ju.

![SOAR](<bilder/Skärmbild 2026-01-23 soar.png>)
